...
import typeEffectiveness from "../../../config/TypeEffectiveness";
...
const BattleResult = ({
  ...
  const calculateTotalEffectiveness = (
    ...
    return (
      ...
      (pokemon1.types.length === 2
        ? totalEffectiveness(pokemon1.types[1], pokemon2.types[0])
        : 0) +
      (pokemon2.types.length === 2
        ? totalEffectiveness(pokemon1.types[0], pokemon2.types[1])
        : 0) +
  ...
  const determineWinner = (): Pokemon | null => {
    ...
    const effectiveness1 = calculateTotalEffectiveness(
      selectedPokemon1,
      selectedPokemon2
    );
    const effectiveness2 = calculateTotalEffectiveness(
      selectedPokemon2,
      selectedPokemon1
    );
